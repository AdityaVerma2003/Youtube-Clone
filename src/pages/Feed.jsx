...
function Feed() {
  ...
  return (
    <>
      ...
      <div className={`pl-0  ${sidebarExtend ? "sm:pl-[180px]" : "sm:pl-[70px]"} feedGrid grid sm:grid-cols-2 md:grid-cols-3 2xl:grid-cols-4 gap-x-[2%] pt-20 mx-2 sm:ml-4 md:pr-[20px] lg:pr-14 gap-y-6 max-w-[100%] bg-contain `}>
